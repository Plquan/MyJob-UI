...
export const resumeSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(resumeThunks.updateAttachedResume.pending, (state) => {
            state.isSubmitting = true;
        })
        builder.addCase(resumeThunks.updateAttachedResume.fulfilled, (state, action) => {
        ...
        builder.addCase(resumeThunks.updateAttachedResume.rejected, (state, action:PayloadAction<any>) => {
            state.isSubmitting = false;
            toast.error(action.payload.errorMessage)
        })
