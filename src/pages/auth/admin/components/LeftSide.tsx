    ...
    return (
        ...
        `}</style>
            ...
            <div className="relative z-10 flex flex-col justify-center items-center w-full px-8">
                <h1 className="text-4xl font-bold text-gray-200 pb-1 pt-1 ">Chào mừng quản trị viên!</h1>
                ...
                <div className="w-full max-w-[420px] flex flex-col gap-3">
                    ...
                    <div className="bg-[rgba(120,120,130,0.18)] rounded-md py-6 px-6 mb-1 flex flex-col items-center transition-transform duration-600 hover:scale-108 hover:shadow-xl">
                        ...
                        <div className="text-2xl font-semibold text-gray-100 mb-1 text-center">Quản lý hệ thống</div>
                        <div className="text-gray-200 text-base text-center opacity-90">Kiểm soát toàn bộ hệ thống</div>
                    </div>

                    <div className="bg-[rgba(120,120,130,0.18)] rounded-md py-6 px-6 mb-1 flex flex-col items-center transition-transform duration-600 hover:scale-108 hover:shadow-xl">
                        <span className="text-3xl mb-2"><UserSwitchOutlined style={{ color: 'white' }} /></span>
                        <div className="text-2xl font-semibold text-gray-100 mb-1 text-center">Quản lý người dùng</div>
                        <div className="text-gray-200 text-base text-center opacity-90">Quản lý tài khoản và phân quyền</div>
                    </div>
                    ...
                    <div className="bg-[rgba(120,120,130,0.18)] rounded-md mb-5 py-6 px-6 flex flex-col items-center transition-transform duration-600 hover:scale-108 hover:shadow-xl">
                        ...
                        <div className="text-2xl font-semibold text-gray-100 mb-1 text-center">Bảo mật cao</div>
                        <div className="text-gray-200 text-base text-center opacity-90">Hệ thống được bảo vệ chặt chẽ</div>
                    </div>
                    <Button
