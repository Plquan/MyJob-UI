...
const LeftSide = ({ mounted }: { mounted: boolean }) => {
    ...
    return (
      <div
        ...
        style={{
          background: 'linear-gradient(120deg,rgb(0, 0, 0) 0%,rgb(93, 15, 189) 100%)' 
        }}
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-8">
          <h1 className="text-4xl font-bold text-gray-200 pb-3 ">Chào mừng trở lại!</h1>
  
          <div className="w-full max-w-[400px] flex flex-col gap-3">
            <div className="bg-[rgba(120,120,130,0.18)] rounded-md py-7 px-7 mb-1 flex flex-col items-center transition-transform duration-600 hover:scale-108 hover:shadow-xl">
            ...
            <div className="bg-[rgba(120,120,130,0.18)] rounded-md mb-5 py-7 px-7 flex flex-col items-center transition-transform duration-600 hover:scale-108 hover:shadow-xl">
